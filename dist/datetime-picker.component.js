import { Component, ElementRef, ViewEncapsulation, ChangeDetectorRef, EventEmitter, ViewChild } from '@angular/core';
...
export var DateTimePickerComponent = (function () {
    ...
    DateTimePickerComponent.propDecorators = {
        '_hours': [{ type: ViewChild, args: ['hours',] },],
        '_minutes': [{ type: ViewChild, args: ['minutes',] },],
    };
